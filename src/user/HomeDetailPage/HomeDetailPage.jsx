...
export default function HomeDetailPage() {
  ...
  return (
    <Wrap>
      ...
      <Card>
        <HeadTitle>
          <HeadTitleText>월세 3000/120</HeadTitleText>
          <HeadTitleActions>
            <IconButton
              ref={btnRef}
              aria-label="옵션 열기"
        ...
        <RoomInfo>84㎡ 관리비 8만원</RoomInfo>
        <RoomName>DMC 파크뷰자이</RoomName>
        <RoomAdress>서울시 서대문구 북가좌동 29-1</RoomAdress>
...
const HeadTitle = styled.h2`
  display:flex; al  ign-items:center; gap:10px;
